" Base16 Equilibrium Gray Light (https://github.com/chriskempson/base16)
" Scheme: Carlo Abelli
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-equilibrium-gray-light.".&background.".sh"
  endif
endif
